package jp.jaxa.iss.kibo.rpc.templateapk;

import jp.jaxa.iss.kibo.rpc.api.KiboRpcService;
import jp.jaxa.iss.kibo.rpc.sampleapk.YOLODetectionService;
...
public class YourService extends KiboRpcService {
    ...
    private final Point[] MOVE_POINTS = {
            ...
            new Point(10.975d, -8.45d, 5.445d),      // Physical Point 1 (for Area 2 and Area 3)
            new Point(10.666984d, -6.8525d, 4.945d)    // Physical Point 2 (for Area 4)
    };

    private final Quaternion[] MOVE_QUATERNIONS = {
            new Quaternion(0.0817f, 0.0082f, 0.6152f, 0.7836f), // Quaternion for Physical Point 0 (Area 1)
            new Quaternion(0f, 0.7939f, 0f, 0.6088f),  // Quaternion for Physical Point 1 (Area 2/3)
